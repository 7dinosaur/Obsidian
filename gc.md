...
对声爆近场演化的研究主要可以分为三个阶段：上世纪六十年代， Whitham[1][2]、Thomas[3]等人建立了声爆预测的基本框架，且Whitham指出近场波形在传播中会发生合并、畸变等非线性演化效应，但由于早期声爆实验数据均呈现标准N波形态，学界因此普遍认为飞行器外形仅能影响N波幅值[5]，Jones在此基础上给出了使N波峰值最小的理论下限[6]；到了70年代，McLean[7]与Hayes[8]发现长机身飞行器的激波合并速率较慢，未完全合并的中场波形可传递至地面，近场波形对声爆的影响开始受到重视，并催生了经典的JSGD声爆最小化理论，该理论构造了一种声爆最小化的近场波形，可使地面信号呈现低声爆的斜坡状形态[6][9][10][11]；90年代至今，学界对近场波系的认识不断深化：如Darden探索出了比斜坡波更优的圆顶状波形[14]，Haas等通过MSID方法将强头激波拆分为多道弱激波以延缓合并[15][16]，Rallabhandi等借助人工神经网络在工程约束下获得了更实用的近场波形目标[17]；这些复杂波系形态最终在NASA低声爆试验机X-59上得到集成验证，其地面信号以多级弱激波逼近圆顶状，声爆强度低于75PLdB，证明了复杂近场波系构型的工程可行性[18]。
